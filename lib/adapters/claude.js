...
// Disable tools that require interactive user input or are not useful in
// --print mode.  Mirrors slock-daemon CLAUDE_DISALLOWED_TOOLS.
...
export const claudeAdapter = {
  ...
  buildSpawnConfig(prompt, _cwd, opts = {}) {
    ...
    return { bin, args, stdinMode: null };
  },
